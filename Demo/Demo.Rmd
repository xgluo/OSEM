...
```{r NPC, cache=TRUE, message=FALSE, warning = FALSE}
...
```{r OPC, cache=TRUE, message = FALSE, warning = FALSE}
...
```{r MMPC, cache=TRUE, message=FALSE, warning = FALSE}
...
```{r OSEM, cache=TRUE, results='hide'}
# the OSEM algorithm
